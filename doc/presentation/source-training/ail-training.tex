...
\title{BitRanger: Darkweb Scanner for Analysis of Information Leaks}
...
\section{BitRanger: Darkweb Scanner}
\begin{frame}
    \frametitle{From a requirement to a solution: BitRanger: Darkweb Scanner}
    \large{History:}
    \begin{itemize}
...
\begin{frame}
    \frametitle{BitRanger: Darkweb Scanner: A framework for Analysis of Information Leaks}
    \begin{quote}
...
\begin{frame}
    \frametitle{BitRanger: Darkweb Scanner: Current capabilities}
    \begin{itemize}
...
\begin{frame}
    \frametitle{BitRanger: Darkweb Scanner: Current features}
    \begin{itemize}
